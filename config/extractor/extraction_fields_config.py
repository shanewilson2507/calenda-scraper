...
FIELDS_TO_EXTRACT = (
   ...
   f"- activity_type: The specific type of activity. TRY to match to one of the following: {ACTIVITY_TYPES}. If NO MATCH is found, you MUST use 'Other'.\n"
    ...
    "- address: The FULL address where the activity is taking place. You MUST include: street address, city, postcode, country. Optionally, include the specific location/building name.\n"
